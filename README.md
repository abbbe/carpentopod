...
![Alt text](images/Pasted image 20241026053241.png)

To keep things 3D-printable I had to make a separate spacer:
![Alt text](images/Pasted image 20241026053802.png)
...
![Alt text](images/Pasted image 20241026053454.png)
...
![Alt text](images/Pasted image 20241026054927.png)
...
![Alt text](images/Pasted image 20241026055336.png)
...
![Alt text](images/Pasted image 20241026060032.png)
## Crank
...
![Alt text](images/Pasted image 20241026061138.png)

Four **ChordHalfCrank** pieces, which are glued together back to back to make two components.
![Alt text](images/Pasted image 20241026061449.png)

Six inserts. ![Alt text](images/Pasted image 20241026061626.png)
...
![Alt text](images/Pasted image 20241026060822.png)
...
![Alt text](images/Pasted image 20241026064713.png)

The piece which gets attached to the motor is called CombinedDriveCrank. It is a combination of RadialCrank (from previous design) and DriveCrank component. If you regenerate 3MF files note that you only need to export the combined part. ![Alt text](images/Pasted image 20241026071920.png)
...
![Alt text](images/Pasted image 20241026064947.png)
...
![Alt text](images/Pasted image 20241026070153.png)
...
![Alt text](images/Pasted image 20241026070519.png)
...
![Alt text](images/Pasted image 20241026071620.png)
...
![Alt text](images/Pasted image 20241026072527.png)
...
![Alt text](images/Pasted image 20241026072942.png)
...
![Alt text](images/Pasted image 20241026073717.png)

![Alt text](images/Pasted image 20241026111514.png)
...
![Alt text](images/Pasted image 20241026113001.png)
...
![Alt text](images/Pasted image 20241026112930.png)
...
![Alt text](images/Pasted image 20241026114257.png)
...
![Alt text](images/Pasted image 20241026113921.png)
...
![Alt text](images/Pasted image 20241026120724.png)
...
![Alt text](images/Pasted image 20241026115237.png)

The covers just nap into place.
![Alt text](images/Pasted image 20241026120505.png)

Put the grey inserts, grease it all.
![Alt text](images/Pasted image 20241026120555.png)
...
![Alt text](images/Pasted image 20241026121206.png)
...
![Alt text](images/Pasted image 20241026121806.png)
...
![Alt text](images/Pasted image 20241026121633.png)
...
![Alt text](images/Pasted image 20241026122155.png)
...
![Alt text](images/Pasted image 20241026123921.png)
...
![Alt text](images/Pasted image 20241026140831.png)
### Assembled View
Here how it looks in the horizontal position:
![Alt text](images/Pasted image 20241026124621.png)

With electronics (the serial links to the ODrives are not attached):
![Alt text](images/Pasted image 20241026142441.png)

Fully assembled and switched on:
![Alt text](images/Pasted image 20241026142533.png)
