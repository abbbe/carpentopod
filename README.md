...
This project was inspired by [Carpentopod](https://www.decarpentier.nl/carpentopod) created by Giliam de Carpentier, all the credits should go to him.
...
Printable 3MF files are uploaded into [3MF/](https://github.com/abbbe/carpentopod-v43/tree/main/3MF) folder. Made in OrcaSlicer, used on Bambu X1C with 0.4mm hardened steel nozzle (see the Printing section below for more details).
